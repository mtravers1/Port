...

{
      id: 1,
      name: "Movie Web App",
      tools: "Docker, MySQL, Flask, Python",
      description: "Developed a full-stack movie web application using Flask for the backend, MySQL as the database engine, and Docker to containerize and orchestrate the entire environment. Implemented a RESTful API in Flask for managing movie data, including adding, updating, and retrieving movie records. ",
      link: "",
      image: flask,
      git: "https://github.com/mtravers1/MovieApp",
      startdate: 10.2025,
      enddate: 12.2025,
    },
{
